package com.moin.appium.parallel.android.pages
...
import com.moin.appium.parallel.android.services.QaModule
...
class NavigationSpec extends Specification {
    ...
    def setupSpec() {
        tester = new TapestryTester("com.moin.appium.parallel.android", "app", "src/main/webapp", QaModule.class)
    }
